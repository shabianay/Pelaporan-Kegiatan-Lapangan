...
<head>
    ...
    <title>Login | LOGBOOM SATPOLPP</title>
    <!-- icon LoGBOOM -->
    <link rel="icon" href="../assets/dist/img/LOGBOOOM.png">
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6">
                <a class="btn logo" href="../index.php">LOGBOOM </a>
                <img src="css/Pemkotsby.png" width="40" height="40">
                <img src="css/SatpolPPsby.png" width="40" height="40">
                <img src="css/LOGBOOM.png" width="40" height="40">
                <p class="lead">Satuan Polisi Pamong Praja Surabaya</p>
                ...
                <form action="" method="post">
                    ...
                    <hr> 
                    <p>Tidak punya akun? Register disini!</p>
