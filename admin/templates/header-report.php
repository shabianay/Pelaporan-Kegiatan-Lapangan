...
<head>
  ...
  <title>Report Data Pelaporan Kegiatan Lapangan</title>
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/LOGBOOM.png" alt="LOGBOOM" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">LOGBOOM SATPOLPP</span>
    </a>
